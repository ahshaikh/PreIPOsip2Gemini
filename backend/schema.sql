...
CREATE TABLE `activity_logs` (
  ...
  PRIMARY KEY (`id`),
  KEY `activity_user_created_index` (`user_id`,`created_at`),
...
CREATE TABLE `bonus_transactions` (
  ...
  KEY `bonus_tx_user_type_index` (`user_id`,`type`),
...
CREATE TABLE `bulk_purchases` (
  ...
  `value_remaining` decimal(14,2) NOT NULL,
  ...
  KEY `idx_product_remaining` (`product_id`,`value_remaining`),
  ...
  CONSTRAINT `check_value_remaining_non_negative` CHECK (`value_remaining` >= 0),
  CONSTRAINT `check_value_remaining_not_over_total` CHECK (`value_remaining` <= `total_value_received`),
  CONSTRAINT `check_total_value_calculation` CHECK (abs(`total_value_received` - `face_value_purchased` * (1 + `extra_allocation_percentage` / 100)) < 0.01)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `company_user_roles` (
  ...
  CONSTRAINT `company_user_roles_assigned_by_foreign` FOREIGN KEY (`assigned_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `deal_approvals` (
  ...
  `approved_by` bigint(20) unsigned DEFAULT NULL,
  `approved_at` timestamp NULL DEFAULT NULL COMMENT 'Timestamp when deal was approved',
  `rejected_by` bigint(20) unsigned DEFAULT NULL,
  `rejected_at` timestamp NULL DEFAULT NULL COMMENT 'Timestamp when deal was rejected',
  `reviewed_at` timestamp NULL DEFAULT NULL,
  `published_at` timestamp NULL DEFAULT NULL,
  ...
  KEY `deal_approvals_reviewed_by_foreign` (`reviewed_by`),
  KEY `deal_approvals_approved_by_foreign` (`approved_by`),
  KEY `deal_approvals_rejected_by_foreign` (`rejected_by`),
  KEY `deal_approvals_approved_at_index` (`approved_at`),
  CONSTRAINT `deal_approvals_approved_by_foreign` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ...
  CONSTRAINT `deal_approvals_reviewed_by_foreign` FOREIGN KEY (`reviewed_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `disclosure_approvals` (
  ...
  CONSTRAINT `disclosure_approvals_requested_by_foreign` FOREIGN KEY (`requested_by`) REFERENCES `users` (`id`),
...
CREATE TABLE `feature_flags` (
  ...
  `percentage` tinyint(3) unsigned NOT NULL DEFAULT 100 COMMENT 'Rollout percentage (0ΓÇô100)',
  PRIMARY KEY (`id`),
...
CREATE TABLE `investment_disclosure_snapshots` (
  ...
  `acknowledgements_snapshot` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Status of all risk acknowledgements at snapshot time: {all_acknowledged, missing, expired, valid}' CHECK (json_valid(`acknowledgements_snapshot`)),
  `acknowledgements_granted` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Specific acknowledgements investor granted during investment flow: {acknowledgement_type: acknowledgement_id}' CHECK (json_valid(`acknowledgements_granted`)),
...
CREATE TABLE `payments` (
  ...
  KEY `payments_status_created_index` (`status`,`created_at`),
  KEY `payments_gateway_payment_index` (`gateway_payment_id`),
...
CREATE TABLE `subscriptions` (
  ...
  KEY `subscriptions_next_payment_index` (`next_payment_date`),
...
CREATE TABLE `transactions` (
  ...
  `paired_transaction_id` bigint(20) unsigned DEFAULT NULL COMMENT 'For double-entry: links debit to credit',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `check_balance_conservation` CHECK (`type` in ('deposit','credit','bonus','refund','referral_bonus') and `balance_after_paise` = `balance_before_paise` + `amount_paise` or `type` in ('debit','withdrawal','investment','fee','tds') and `balance_after_paise` = `balance_before_paise` - `amount_paise`),
...
CREATE TABLE `user_investments` (
  ...
  `exited_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_investments_payment_id_foreign` (`payment_id`),
  KEY `user_investments_bulk_purchase_id_foreign` (`bulk_purchase_id`),
  KEY `investments_user_product_index` (`user_id`,`product_id`),
  KEY `user_investments_subscription_id_index` (`subscription_id`),
  KEY `idx_product_active_allocations` (`product_id`,`is_reversed`),
...
CREATE TABLE `user_tutorial_progress` (
  ...
  `steps_completed` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '[]' CHECK (json_valid(`steps_completed`)),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `user_tutorial_progress_tutorial_id_index` (`tutorial_id`),
...
CREATE TABLE `wallets` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `wallets_user_index` (`user_id`),
  KEY `idx_wallet_locked` (`user_id`,`locked_balance_paise`),
...
CREATE TABLE `withdrawals` (
  ...
  KEY `withdrawals_user_status_index` (`user_id`,`status`),
  KEY `withdrawals_status_created_index` (`status`,`created_at`),
  KEY `idx_withdrawals_idempotency_key` (`idempotency_key`),
  KEY `withdrawals_amount_paise_index` (`amount_paise`),
  KEY `withdrawals_net_amount_paise_index` (`net_amount_paise`),
...
-- Dump completed on 2026-02-01  3:54:43
