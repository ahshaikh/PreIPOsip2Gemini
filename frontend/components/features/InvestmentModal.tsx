          ...
          <div className="space-y-6 py-4">
            ...
            {subscriptions.length === 0 ? (
              ...
              <>
                ...
                <div className="bg-muted p-4 rounded-lg space-y-2">
                  ...
                  {selectedSub && (
                    <>
                      ...
                      {totalAmount > selectedSub.available_balance && (
                ...
                {totalAmount <= (selectedSub?.available_balance || 0) && shares >= minShares && (
                  <div className="flex items-start gap-2 bg-green-50 dark:bg-green-900/20 p-3 rounded text-sm text-green-700 dark:text-green-400">
                    ...
                    <p>Investment ready to be confirmed</p>
                  </div>
                )}
                ...
                <Button
                  ...
                  disabled={
                    ...
                    shares < minShares ||
                    totalAmount > (selectedSub?.available_balance || 0) ||
