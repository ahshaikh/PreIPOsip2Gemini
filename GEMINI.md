...
# Gemini Code System Rules — Governance-Grade Fix Protocol
...
Gemini Code — Governance-Grade Fix Protocol (System Prompt)
You must fix errors by restoring root causes and invariants, never by masking symptoms.
...
> This project adheres to a strict **"Zero Hardcoded Values"** philosophy. All in DB with audit logs. 
> * **DO NOT** hardcode business logic, limits, fees, or bonuses.
> * **ALWAYS** fetch configuration from the `settings` table or related configuration models.
